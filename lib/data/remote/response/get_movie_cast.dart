...
class GetMovieCastResponse {
  ...
  factory GetMovieCastResponse.fromMap(Map<String, dynamic> map) {
    return GetMovieCastResponse(
      id: map['id']?.toInt(),
      cast: map['cast'] != null
          ? List<Cast>.from(map['cast']?.map((x) => Cast.fromMap(x)))
          : null,
    );
  }
  ...
  factory GetMovieCastResponse.fromJson(String source) =>
      GetMovieCastResponse.fromMap(json.decode(source));

  @override
  String toString() => 'GetMovieCastResponse(id: $id, cast: $cast)';

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;

    return other is GetMovieCastResponse &&
        other.id == id &&
